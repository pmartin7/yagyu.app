...
- 15 agent skills (research, plan, build, test, design, debug, and more)
- 3 specialist agent roles (staff reviewer, bug fixer, designer)
...
│
├── .agents/agents/          Specialist agent role definitions
...
(like "staff reviewer" or "bug fixer") that skills delegate to for expert
